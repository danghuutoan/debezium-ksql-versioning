...
CREATE TABLE orders (
  ...
  `_updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY order_customer (purchaser) REFERENCES customers(id),
  FOREIGN KEY ordered_product (product_id) REFERENCES products(id)
) AUTO_INCREMENT = 10001;

INSERT INTO orders
VALUES (default, '2016-01-16', 1001, 1, 102, default),
       (default, '2016-01-17', 1002, 2, 105, default),
       (default, '2016-02-19', 1002, 2, 106, default),
       (default, '2016-02-21', 1003, 1, 107, default);
